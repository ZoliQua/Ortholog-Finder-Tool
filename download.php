...
if(isset($_GET["file"])) {
	...
	if(!isset($_GET["name"])) $kiir = "This file is downloaded from OrthologFinderTool.com, on ". date('d/m/y H:i:m') . ", query name was: ". str_replace('_query/jsonquery_', '', str_replace('.txt', '', $_GET['file'])) . "\n\n";
	else $kiir = "This file is downloaded from OrthologFinderTool.com, on ". date('d/m/y H:i:m') . ", query name was: ". str_replace('../_query/jsonquery_', '', str_replace('.txt', '', $filename)) . "\n\n";
